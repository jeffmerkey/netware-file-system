...
long FileSeekEnd (HANDLE hFile,
		  long lAmtToMove,
		  long lAmountToMoveHigh)
   {  // FileSeekEnd
   return (SetFilePointer (hFile, lAmtToMove, &lAmountToMoveHigh, FILE_END)) ;
   }  // FileSeekEnd
...
long FileSeekBegin (HANDLE hFile,
		    ...
		    long lAmountToMoveHigh)
   {  // FileSeekBegin
   return (SetFilePointer (hFile, lAmtToMove, &lAmountToMoveHigh, FILE_BEGIN)) ;
   }  // FileSeekBegin
...
long FileSeekCurrent (HANDLE hFile,
		      ...
		      long lAmountToMoveHigh)
   {  // FileSeekCurrent
   return  (SetFilePointer (hFile, lAmtToMove, &lAmountToMoveHigh, FILE_CURRENT)) ;
   }  // FileSeekCurrent
...
BOOL FileUnMap (VOID *pBase, HANDLE hMapping)
/*
   To Do:         Error reporting!!
*/
   {  // FileUnMap
